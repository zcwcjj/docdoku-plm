...
public class ProductTest {
    ...
    public void testCreationPartMasterFromTemplate() throws Exception {
        ...
        partManagerBean.testPartMasterCreation("user1", "TEST_WORKSPACE", "plane_125", " ", true, null, "", "template1", null, null, null).getNumber();
    }
    ...
    public void testMaskValidityPartTemplate() throws Exception {
        ...
        assertEquals(partManagerBean.findPartMaster("user1", "TEST_WORKSPACE", "ref_1235"), 0);
        assertEquals(partManagerBean.findPartMaster("user1", "TEST_WORKSPACE", "ref_125"), 1);
    }


    public void testACLPartMaster(){

    }
    public void testObligatoryAttributesPartMasterTemplate(){
